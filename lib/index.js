...
function startLoadingScripts(scripts) {
  ...
  // sequence load
  var loadNewScript = function loadNewScript(script) {
    var src = (typeof script === 'undefined' ? 'undefined' : _typeof(script)) === 'object' ? script.src : script;
    if (loadedScript.indexOf(src) < 0) {
      return function (taskComplete) {
        ...
        if (callbacks.length === 1) {
          return (0, _utils.newScript)(script)(function (err) {
